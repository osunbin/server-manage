...
public class ReflectUtil {
    ...
    public static Map<String,Object> getFieldValue(Object obj, Set<String> fieldNames) {
        if (null == obj || fieldNames == null || fieldNames.isEmpty()) {
            return null;
        }
    ...
    public static void setFieldValue(Object obj, String fieldName, Object value) throws RuntimeException {
        ...
        Objects.requireNonNull(field, "Field [" + fieldName + "] is not exist in [" + obj.getClass().getName() + "]");
        setFieldValue(obj, field, value);
    }

    public static void setFieldValue(Object obj, Field field, Object value) throws RuntimeException {
        Objects.requireNonNull(field, "Field in [" + obj + "] not exist !");
