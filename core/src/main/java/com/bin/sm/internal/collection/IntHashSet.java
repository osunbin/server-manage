...
import static com.bin.sm.util.HashUtil.intHash;
import static com.bin.sm.util.Preconditions.checkNotNull;
import static com.bin.sm.util.Preconditions.checkTrue;
import static com.bin.sm.util.QuickMath.nextPowerOfTwo;
